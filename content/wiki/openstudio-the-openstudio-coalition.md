...
The OpenStudio Coalition is an organization formed to support the [OpenStudio Application](/openstudio-openstudio-application/) and to expand the use of energy modeling generally using the free and open-source OpenStudio Application. The stated goals of the OpenStudio Coalition (OSC) include[^1]:
...
## External References
- [OpenStudio Coalition Website](https://openstudiocoalition.org/)

## Notes


[^1]: The OpenStudio Coalition. (2020). About the OpenStudio Coalition. Openstudiocoalition.org. https://openstudiocoalition.org/about/openstudio_coalition/
